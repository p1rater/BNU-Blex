...
# Blexx-OS System Requirements & Specifications

This document outlines the hardware and software prerequisites for building and running **Blexx-OS**.

---

## 🛠 1. Hardware Requirements

Blexx-OS is an ultra-lightweight kernel designed for "bare metal" x86 execution.
